...
//        demoStyle.up = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("img/menu/instructionsButtonInactive.png"))));
//        demoStyle.down = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("img/menu/instructionsButtonActive.png"))));
//        demoStyle.over = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("img/menu/instructionsButtonActive.png"))));
