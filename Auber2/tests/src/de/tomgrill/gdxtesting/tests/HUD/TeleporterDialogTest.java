...
public class TeleporterDialogTest {
    ...
    public void testAssets(){
        ...
        try {
            assertTrue("teleporter.mp3 is missing", Gdx.files.internal("audio/teleporter.mp3").exists());
        }catch (AssertionError e){
            System.out.println(e.getMessage());
            errors = true;
        }
        try {
            assertTrue("uiskin.json is missing", Gdx.files.internal("skin/uiskin.json").exists());
        }catch (AssertionError e){
            System.out.println(e.getMessage());
            errors = true;
        }
